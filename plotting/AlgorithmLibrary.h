...
public:
  ...
  std::tuple<std::vector<TFile*>, std::vector<TString>, std::vector<TString>, std::vector<std::vector<bool>>, TString> ReadFileListWithDebug(TString inputFileList); // Read a list of specifically formatted files
